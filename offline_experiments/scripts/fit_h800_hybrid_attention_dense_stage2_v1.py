...
from hybrid_attention_memory_features_v2 import (
    SCHEMA as FEATURE_SCHEMA_V2,
    zero3_param_workspace_from_basis,
)

PROTOCOL_SCHEMA = "sft_h800_hybrid_attention_dense_stage2_fit_protocol/v1"
REPORT_SCHEMA = "sft_h800_hybrid_attention_dense_stage2_fit_report/v1"
ARTIFACT_SCHEMA = "sft_h800_hybrid_memory_artifact/v2"

PROTOCOL_PATH = ARTIFACT_DIR / "h800_hybrid_attention_dense_stage2_fit_protocol_v1.json"
FIT_REPORT_PATH = ARTIFACT_DIR / "h800_hybrid_attention_dense_stage2_fit_report_v1.json"
ARTIFACT_PATH = ARTIFACT_DIR / "h800_hybrid_memory_artifact_v2.json"
...
def protocol_payload() -> dict[str, Any]:
    return {
        ...
        "campaign_id": "h800_hybrid_attention_dense_stage2_20260818_v1",
        "frozen_at_utc": datetime.now(timezone.utc).isoformat(),
        "fit_script": {"path": str(Path(SCRIPT_PATH).resolve()), "sha256": sha256_file(Path(SCRIPT_PATH))},
        "feature_module_schema": FEATURE_SCHEMA_V2,
