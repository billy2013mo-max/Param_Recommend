...
from prepare_h800_hybrid_vl_prospective_acceptance_v3 import (
    CAMPAIGN_ID,
    COMBINED_QUEUE,
    DESIGN,
    FROZEN_PREDICTIONS,
...
SCOPED_SOURCE_RELATIVE_PATHS = (
    ...
    "scripts/prepare_h800_hybrid_vl_prospective_acceptance_v3.py",
    "scripts/freeze_h800_hybrid_vl_prospective_acceptance_v3.py",
    "scripts/evaluate_h800_hybrid_vl_prospective_acceptance_v3.py",
    "scripts/fit_h800_hybrid_attention_dense_stage2_v1.py",
    "scripts/fit_h800_hybrid_vl_safety_upper_v4.py",
...
def _validate_inputs() -> list[dict[str, Any]]:
    ...
    if (
        ...
        raise ValueError("combined queue is not the exact ordered 18+27 prospective design")
    ...
    if (
        ...
        or predictions.get("schema") != "sft_h800_hybrid_vl_prospective_frozen_predictions/v3"
        or predictions.get("safety_upper", {}).get("sha256") != sha256_file(UPPER_V4)
        ...
        or disjoint.get("vl_prospective_source") != "blind_data/vl frames grid (1/2/4) synthetic prompt"
    ):
...
def freeze(candidate_path: Path) -> Path:
    ...
    bound_files: set[Path] = {
        ...
        FROZEN_PREDICTIONS,
        UPPER_V4,
        ARTIFACT_DIR / "h800_hybrid_memory_artifact_v3.json",
